<template>
    <modal-dark @close="store.close">
        <div class="content-wrapper" data-test="collection-create-wrapper">
            <input-text class="section" id="input-name" v-model="store.form.name" :label="t('LABEL.NAME')"
                :placeholder="t('PLACEHOLDER.NAME')" :important="true" data-test="collection-create-name" />
            <input-text class="section" id="input-theme" v-model="store.form.theme" :label="t('LABEL.THEME')"
                :placeholder="t('PLACEHOLDER.THEME')" data-test="collection-create-theme" />
            <input-text class="input-description section" id="input-desc" v-model="store.form.description"
